...
FROM (
    ...
    HAVING func_tags['ext'] = 'spatial_raster'
...
def get_functions(function_type = 'scalar'):
    functions = []
    for line in os.popen("./build/debug/duckdb -list -noheader -c \"" + get_spatial_r_functions_sql.replace('$FUNCTION_TYPE$', function_type) + "\"").readlines():
...
def main():
    with open("./docs/functions.md", "w") as f:
        ...
        f.write("# DuckDB Spatial Raster Function Reference\n\n")
